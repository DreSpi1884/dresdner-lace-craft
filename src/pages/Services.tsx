...
const Services = () => {
  ...
  const services = useMemo((): ServiceItem[] => [
    ...
    },
    {
      ...
      text: t(
        "We develop functional warp-knitted fabrics for technical and medical applications. Our textiles are used in compression garments and post-surgical products where consistent performance is essential.",
        "Wir entwickeln funktionale Kettengewirke für technische und medizinische Anwendungen. Unsere Textilien werden in beispielsweise Kompressionsbekleidung, postoperativen Produkten eingesetzt, wo zuverlässige Qualität entscheidend ist."
      ),
    },
  ], [t, processSteps]);
