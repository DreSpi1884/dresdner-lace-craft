          ...
          <div className="px-6 pt-2">
            ...
            {section.id === "sustainability" && (
              <div className="space-y-8 text-lg md:text-xl leading-[2] text-muted-foreground">
                <p>
                  {t(
                    "Our production is supported by an energy management system and certified according to internationally recognised standards, including OEKO-TEX® Standard 100, OEKO-TEX® STeP Level 3 and the Global Recycled Standard (GRS). These certifications reflect our commitment to responsible textile manufacturing, transparent supply chains and resource-conscious production. In addition, part of the electricity used at our Dresden site is generated by our own solar power systems.",
                    "Unsere Produktion wird durch ein Energiemanagementsystem unterstützt und ist nach international anerkannten Standards zertifiziert, darunter OEKO-TEX® Standard 100, OEKO-TEX® STeP Level 3 sowie der Global Recycled Standard (GRS). Diese Zertifizierungen stehen für verantwortungsvolle Textilherstellung, transparente Lieferketten und ressourcenschonende Produktionsprozesse. Einen Teil des an unserem Standort in Dresden genutzten Stroms erzeugen wir über eigene Solaranlagen."
                  )}
                </p>
              </div>
            )}
