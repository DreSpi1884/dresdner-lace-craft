...
const SolarImageCard = ({
  ...
  <figure className="group relative -mx-6 overflow-hidden bg-muted lg:mx-0">
    ...
    <figcaption className="absolute inset-0 flex items-end bg-transparent px-6 py-6 opacity-100 transition-opacity duration-500 lg:items-end lg:bg-foreground/45 lg:px-8 lg:py-7 lg:opacity-0 lg:group-hover:opacity-100">
      <>
...
const SustainabilityLogos = ({
  ...
  >
    <img
      ...
      className="w-[100px] shrink-0 bg-white object-contain md:w-[140px] lg:w-[145px] xl:w-[165px]"
    />
    ...
    <img
      ...
      className="w-[118px] shrink-0 bg-white object-contain md:w-[165px] lg:w-[170px] xl:w-[195px]"
    />
    ...
    {!excludeUmweltallianz && (
      <img
        ...
        className="w-[60px] shrink-0 object-contain md:w-[90px] lg:w-[86px] xl:w-[100px]"
      />
    )}
  </div>
);
