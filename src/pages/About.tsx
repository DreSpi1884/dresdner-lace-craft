  ...
  >
    ...
    >
     <img
        ...
        className="block w-[70px] shrink-0 bg-white object-contain sm:w-[90px] md:w-[130px] lg:w-[180px] xl:w-[230px]"
      />
    </a>
    ...
    <img
      ...
      src={oekoTexLogo}
      alt="OEKO-TEX STeP"
      className="block w-[72px] shrink-0 bg-white object-contain sm:w-[90px] md:w-[130px] lg:w-[180px] xl:w-[230px]"
    />
