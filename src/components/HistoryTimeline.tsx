    ...
    () => [
      {
        ...
        text: t(
          ...
          "Unsere Geschichte beginnt 1884, als Georg Marwitz und Carl Siegel die Dresdner Gardinen- und Spitzen-Manufaktur gründen.\nZu einer Zeit, als feine Spitze fast ausschließlich aus England importiert wird, bringen sie englische Bobinet-Maschinen nach Deutschland und legen den Grundstein für die moderne Spitzenherstellung in Dresden."
        ),
      },
      {
